<!-- jumbotron -->
    <div class="jumbotron text-center">
      ...
      <h2>Website ini Hanya Dapat Meranking 3 alternatif cek Bagian "View Daftar Mobil di Navigasi" Jika Terdapat data silahkan hapus telebih dahulu lalu kembali menginputkan datanya.</h2>
      <hr>
    </div>
<!-- akhir jumbotron -->
...
<section class="inputan" id="inputan">
	<div class="container">
		<div class="row">
		<div class="col-sm-12">
			<form style="font-size: 20px"  action="<?php echo base_url(). 'Mobnew/tambah_aksi'; ?>" method="post" >
